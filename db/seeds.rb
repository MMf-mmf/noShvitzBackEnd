...
40.times do 
    User.create(
        ...
        activated: true, admin: false, employee: false
    )
end
...
product12 = Product.create!(name: "Dalton", company: "galil", category_id: cat1.id,  price: 99.00, image: "https://assets.healthytokyo.com/wp-content/uploads/20180820104343/7290014503830A.jpg",  limit: 7)
...
product14 = Product.create!(name: "Flam", company: "kedem", category_id: cat1.id,  price: 99.99, image: "https://www.kosherwine.co.uk/images/flam-syrah-reserve-p3828-10444_image.jpg",  limit: 8)
...
product8 = Product.create!(name: "Carrots", company: "Guardian", category_id: cat3.id,  price: 3.50, image: "https://www.ugaoo.com/knowledge-center/wp-content/uploads/2016/05/carrots-1.jpg",  limit: 8)
...
product10 = Product.create!(name: "Apples", company: "IKEA", category_id: cat3.id,  price: 6.50, image: "https://seattle.cbslocal.com/wp-content/uploads/sites/15909838/2011/09/120716788.jpg?w=1500" ,  limit: 9)
